...
class CSVDataTable( DataTable ):
    ...
    def __init__(self, refresh_minutes=1, csv_spec = None, csv_map= None, name= None ):
        ...
        DataTable.__init(self,None,(csv_name if csv_name else "CSVDataTable"),refresh_minutes)
        self.refresh()
